...
public class EnemyBoss1 : MonoBehaviour
{
    ...
    void Enemy_AI()
    {
        ...
        {
            GameObject LaserBoss2 = GameObject.Instantiate(LaserBoss02, this.gameObject.transform.position, Quaternion.identity) as GameObject;
